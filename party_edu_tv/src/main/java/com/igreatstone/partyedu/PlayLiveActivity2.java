...
import com.igreatstone.base.mobile.player.video.SampleLiveVideo;
 ...
 */
public class PlayLiveActivity2 extends AppCompatActivity {

    public final static String IMG_TRANSITION = "IMG_TRANSITION";
    public final static String TRANSITION = "TRANSITION";

//    @BindView(R.id.video_player_live)
    SampleLiveVideo videoPlayer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        videoPlayer= (SampleLiveVideo) findViewById(R.id.video_player_live);
