package com.igreatstone.base.mobile.player.video;
...
import com.igreatstone.base.mobile.player.R;
import com.igreatstone.base.mobile.player.model.SwitchVideoModel;
import com.igreatstone.base.mobile.player.view.SwitchVideoTypeDialog;
...
public class SampleLiveVideo extends StandardGSYVideoPlayer {
...
//        }
    ...
    public int getLayoutId() {
        return R.layout.sample_live_video;
    }
    ...
    public GSYBaseVideoPlayer startWindowFullscreen(Context context, boolean actionBar, boolean statusBar) {
        SampleLiveVideo sampleVideo = (SampleLiveVideo) super.startWindowFullscreen(context, actionBar, statusBar);
    ...
    protected void resolveNormalVideoShow(View oldF, ViewGroup vp, GSYVideoPlayer gsyVideoPlayer) {
        ...
        if (gsyVideoPlayer != null) {
            SampleLiveVideo sampleVideo = (SampleLiveVideo) gsyVideoPlayer;
