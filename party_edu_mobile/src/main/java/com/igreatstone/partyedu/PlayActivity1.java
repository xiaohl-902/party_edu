...
//    @BindView(R.id.video_player)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (videoplayBean == null) {
            ...
            String videoUrl = bundle.getString("playUrl");
            videoplayBean.setVideoUrl(videoUrl);
        }
...
//        list.add(switchVideoModel2);
        ...
        //int playTime = videoplayBean.getPlayTime()==null||videoplayBean.getPlayTime()==""?0:Integer.parseInt(videoplayBean.getPlayTime());
        int playTime = videoplayBean.getLastPlayTimes()==null||videoplayBean.getLastPlayTimes()==""?0:Integer.parseInt(videoplayBean.getLastPlayTimes());
         videoPlayer.setSeekOnStart(playTime*1000);
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (GSYVideoManager.instance().getMediaPlayer().isPlaying()) {
                            ...
                            //int playtime = Integer.parseInt(playTime==null?"1000":playTime) / 1000;
                            /*String playTime = videoplayBean.getLastPlayTimes();
                            int playtime = Integer.parseInt(playTime == null ? "1" : playTime);
...
//                                    Log.e("play_time", play_time + "play_time: -------------" + isComplete);
    ...
    private void synPlayLog(long playlogtime, final String isComplete) {
